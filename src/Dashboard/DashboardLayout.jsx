...
const DashboardLayout = () => {
  ...
  // Wrapper theme class (light/dark)
  const wrapperClass = theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-900";
  const sidebarClass = theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-300";
  const contentClass = theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-300";
  const hoverClass = theme === "dark" ? "hover:bg-gray-700" : "hover:bg-gray-200";
    ...
    <div className={`min-h-screen ${wrapperClass}`}>
      <div className="flex min-h-screen p-6 md:p-10">
        ...
        <aside className={`w-[320px] flex flex-col border ${sidebarClass}`}>
          ...
          {/* TOP */}
          <div className={`px-8 py-6 border-b ${theme === "dark" ? "border-gray-700" : "border-gray-300"}`}>
            <Logo />
          ...
          {/* FOOTER */}
          <div className={`border-t p-6 space-y-3 ${theme === "dark" ? "border-gray-700" : "border-gray-300"}`}>
            <Link
              to="/"
        ...
        {/* CONTENT */}
        <main className={`flex-1 ml-8 p-6 md:p-10 rounded-md shadow-sm border ${contentClass}`}>
          <Outlet />
        </main>
      </div>
    </div>
